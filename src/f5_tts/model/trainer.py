...
class Trainer:
    ...
    def save_checkpoint(self, update, last=False):
        ...
        if self.is_main:
            checkpoint = dict(
                ...
                optimizer_state_dict=self.optimizer.state_dict(),  # FIX: optimizer doesn't need unwrap
    ...
    def load_checkpoint(self):
        ...
        if "update" in checkpoint or "step" in checkpoint:
            ...
            self.optimizer.load_state_dict(checkpoint["optimizer_state_dict"])  # FIX: optimizer doesn't need unwrap
            if self.scheduler:
